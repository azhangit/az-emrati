...
@section('content')
<!--in product listing-->
    <section class=" pt-4 " style="background-color:#F8F9FA;">
            ...
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                    ...
                    <div class="col-xl-12 p-0">
                        ...
                        <!-- Breadcrumb -->
                        <ul class="breadcrumb bg-transparent py-0 px-1 justify-self-center">
                        ...
                        <div class="text-left my-5 ">
                            <div class="row gutters-5 w-100 flex-wrap align-items-center ">
                                <div class=" col-12 text-center">
                                    <h1 class="text-center text-uppercase text-dark top-listing-pl">
                                        @if(isset($category_id))
                                            {{ $category->getTranslation('name') }}
                                        @elseif(isset($query))
...
<p class="w-50 mx-auto bold d-flex fw-bold text-center top-listing-pl">{{ translate('Delivering to all Emirates in the UAE at a rate of AED 30.00 and Abu Dhabi/Western Regions at a rate of AED 40.00. Delivering Internationally; All International Shipments are subject to Courier Charges.') }}</p>
                                </div>
                                ...
                                <!--    @endif-->
                                <!--</div> -->
                                <div class="col-6 col-lg-auto mb-3 w-lg-200px filter azhan d-none">
                                    <select class="form-control form-control-sm aiz-selectpicker rounded-0 bg-white p-0 filter" name="sort_by" onchange="filter()">
   
                                        <option value="newest" class="bg-white text-dark filter" @isset($sort_by) @if ($sort_by == 'newest') selected @endif @endisset>{{ translate('Newest')}}</option>
                                        <option value="oldest" class="bg-white text-dark filter" @isset($sort_by) @if ($sort_by == 'oldest') selected @endif @endisset>{{ translate('Oldest')}}</option>
                                        <option value="price-asc" class="bg-white text-dark filter" @isset($sort_by) @if ($sort_by == 'price-asc') selected @endif @endisset>{{ translate('Price low to high')}}</option>
                                        <option value="price-desc"class="bg-white text-dark filter" @isset($sort_by) @if ($sort_by == 'price-desc') selected @endif @endisset>{{ translate('Price high to low')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<div class="row g-4 justify-content-center">
    @foreach ($products as $product)
        <div class="col-10 col-sm-6 col-md-6 col-lg-4 col-xxl-3">
            <div class="bg-white drip-box shadow-sm hover-shadow rounded-4 p-4 h-100 d-flex flex-column justify-content-between transition-all" style="min-height: 480px;">
    ...
    @endforeach
                        ...
                        <div class="aiz-pagination mt-4 py-4">
