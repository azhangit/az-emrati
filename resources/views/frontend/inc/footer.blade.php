 ...
 .footer {
  ...
  /* --- WHATSAPP ICON STYLES --- */
      .footer .whatsapp-icon {
          position: fixed; /* Makes the icon stay in place */
          transition: transform 0.3s ease;
        }

        /* Make the SVG icon a bit smaller inside the circle */
...
<div class="footer text-center col-12">
    <div class="whatsapp-icon contact-icon" >
        <a href="https://wa.me/+971 50 474 6450" target="_blank" aria-label="Chat on WhatsApp">
<svg width="48px" height="48px" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-whatsapp fa-w-14 fa-9x"><path fill="currentColor" d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-32.6-16.3-54-29.1-75.5-66-5.7-9.8 5.7-9.1 16.3-30.3 1.8-3.7.9-6.9-.5-9.7-1.4-2.8-12.5-30.1-17.1-41.2-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 35.2 15.2 49 16.5 66.6 13.9 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z" class=""></path></svg>
    ...
    <div class="col-lg-6 mb-2  align-content-center">
        <ul class="d-flex list-unstyled policies m-0">
            <li><a href="privacy-policy">{{ translate('Privacy Policy') }}</a></li>
            <li><a href="refund-return-policy">{{ translate('Refund & Return Policy') }}</a></li>
            <li><a href="shipping-policy">{{ translate('Shipping Policy') }}</a></li>
            <li><a href="terms-conditions">{{ translate('Terms & Conditions') }}</a></li>
<li>
  <a href="tel:+971 56 500 3468">
    {{ translate('Call Now') }}
  </a>
</li>
...
<li>
      <a 
  href="https://maps.app.goo.gl/mQiJBBkh8LVtYQFh6" 
  target="_blank" 
...
{{ translate('Get Directions') }}
    ...
    <div class="col-lg-3 mb-2 align-content-center">
      <span>{{ translate('Copyright © 2025 Emirati Coffee Co . All Rights Reserved.') }}</span>
    </div>
...
<!-- Mobile bottom nav -->
{{-- <div clsss="d-none" style="background-color: rgb(255 255 255 / 90%)!important;">
    <div clsss="d-none">
        <!-- Home -->
        <div class="col">
            <a href="{{ route('home') }}" class="clsss="d-none" {{ areActiveRoutes(['home'],'svg-active')}}">
        ...
        <!-- Categories -->
        <div class="col">
            <a href="{{ route('categories.all') }}" class="clsss="d-none" {{ areActiveRoutes(['categories.all'],'svg-active')}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        ...
        @endphp
        <div class="col-auto">
            <a href="{{ route('cart') }}" class="clsss="d-none" px-3 {{ areActiveRoutes(['cart'],'svg-active')}}">
        ...
        <!-- Notifications -->
        <div class="col">
            <a href="{{ route('all-notifications') }}" class="clsss="d-none" {{ areActiveRoutes(['all-notifications'],'svg-active')}}">
                <span class="d-inline-block position-relative px-2">
        ...
        <div class="col">
            @if (Auth::check())
                @if(isAdmin())
                    <a href="{{ route('admin.dashboard') }}" class="clsss="d-none"">
                ...
                @elseif(isSeller())
                    <a href="{{ route('dashboard') }}" class="clsss="d-none"">
                        <span class="d-block mx-auto">
                            @if($user->avatar_original != null)
                                <img src="{{ $user_avatar }}" alt="{{ translate('avatar') }}" class="rounded-circle size-20px">
                            @else
                ...
                @else
                    <a href="javascript:void(0)" class="clsss="d-none" mobile-side-nav-thumb" data-toggle="class-toggle" data-backdrop="static" data-target=".aiz-mobile-side-nav">
                        <span class="d-block mx-auto">
                            @if($user->avatar_original != null)
                                <img src="{{ $user_avatar }}" alt="{{ translate('avatar') }}" class="rounded-circle size-20px">
                            @else
                ...
                @endif
            @else
                <a href="{{ route('user.login') }}" class="clsss="d-none"">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
...
.box input[type="radio"] {
  ...
  position: relative;
  cursor: pointer;
  background-color: white; /* Ensures unselected state */
}

/* Create a white tick when selected */
...
const POPUP_API_BASE = "{{ url('/') }}";

function fetchProductDetails(slug) {
  const t0 = performance.now();
  console.groupCollapsed(`[POPUP] Fetching product ${slug}`);
//  console.log("→ Request URL:", `${POPUP_API_BASE}/product/api/${slug}`);

  $.ajax({
    url: `${POPUP_API_BASE}/product/api/${slug}`,
    type: "GET",
    dataType: "json",

    success: function (response) {
      try {
      //  console.log("[POPUP] success, keys:", Object.keys(response || {}));
        if (!response || !response.html) {
          console.warn("response.html missing");
          return;
        }
        ...
        if (!overlay) {
          console.error("#popupOverlay missing in DOM");
          return;
        }

        // Inject HTML
        $("#content-pop").html(response.html);
      //  console.log("✔ HTML injected");

        // Plugins (safe)
        if (window.AIZ?.plugins?.slickCarousel) AIZ.plugins.slickCarousel();
        try {
          if (window.AIZ?.plugins?.zoom && $.fn?.zoom) {
            AIZ.plugins.zoom();
          } else {
            console.warn("[POPUP] zoom plugin missing — skipping");
          }
        } catch (e) {
          console.warn("[POPUP] zoom init error — skipping", e);
        }

        // Stock/price first, then qty init
        if (typeof getVariantPrice === "function") getVariantPrice();
        setTimeout(function () {
          if (window.AIZ?.extra?.plusMinus) AIZ.extra.plusMinus();
        }, 0);

        // Re-init on option change
        $('#option-choice-form input')
          .off('change.init')
        ...
        // SHOW POPUP (correct place)
        overlay.style.display = "flex";

      } catch (e) {
        console.error("Exception in success handler:", e);
      }
    },
    ...
    error: function (xhr) {
     ...
     // console.log("responseText preview:", txt.slice(0, 400), "…");
    },

    complete: function () {
      const t1 = performance.now();
   //   console.log(`⏱️ Completed in ${(t1 - t0).toFixed(1)} ms`);
      console.groupEnd();
    }
  });
}

// Delegate click (reliable for all buttons/links)
document.addEventListener("DOMContentLoaded", function () {
  document.addEventListener("click", function (e) {
    ...
    if (!slug) return console.warn("No data-slug on .openPopup");
