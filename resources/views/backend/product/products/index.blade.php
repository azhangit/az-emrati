            ...
            @can('product_delete')
                <div class="dropdown mb-2 mb-md-0">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item new-dropdown-item confirm-alert" href="javascript:void(0)"  data-target="#bulk-delete-modal"> {{translate('Delete selection')}}</a>
                    </div>
                </div>
            @endcan
            <style>
                .new-dropdown-item{color:#000;}
                .new-dropdown-item:hover{color:#000;}
            </style>
            @if($type == 'Seller')
