...
<div class="main-content">
    ...
    <div class="hero-section ">
        ...
        <video autoplay loop muted playsinline>
            <source src="{{ asset('public/assets/img/emrati-video.mp4') }}" type="video/mp4">
      ...
      <div class="container-fluid text-center p-0">
         ...
         <div class="row ">
            ...
            <div class="banner-right banner-ip text-dark " style="background-image: url('{{ asset('public/assets/img/home-page/EMIRATI-COFFEE-7.jpg')}}">
             ...
             <div class=" pt-5 ">
              ...
              <p class="sub-para fw-normal">United by rhythm. Discover the new Black Unity watch band and face.
                 </p>
            ...
            <div class="banner-right text-dark  img-2" style="background-image: url('{{ asset('public/assets/img/home-page/EMIRATI-COFFEE-6.jpg')}}"> <div class=" pt-5 ">
             <!--promo_apple_fitness.png-->
              ...
              <!--<h5>Anaerobic Natural</h5>-->
              <p class="sub-para fw-normal">Thinstant classic.
                 </p>
           <div class="py-3">
        ...
        <div class="row">
            ...
            <div class="banner-left  pb-5" style="background-image: url('{{ asset('public/assets/img/home-page/EMIRATI-COFFEE-9.jpg')}}">
              ...
              <h3>Subscriptions</h3>
             <p class="sub-para fw-normal">Unbelievably thin. Incredibly powerful.
                 </p>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-md-2" id="side-by-side">
            <div class="banner-left subhead-left text-center img-5 text-left p-3 text-dark "  style="background-image: url('{{ asset('public/assets/img/home-page/EMIRATI-COFFEE-8.jpg')}}">
              ...
              <h6>Event</h6>
              <h3>Wholesale</h3>
              <p class="sub-para fw-normal">Get $180–$650 in credit when you trade in iPhone 12 or higher.
                 </p>
...
<style>
  ...
  /* Reel slider styles for the new container */
...
.slider-track-2 {
  ...
  animation: slideInfinite 40s linear infinite; /* Smooth looping animation */
}
...
.slide-2 img {
  width: 440px; /* Width for larger screens */
  height: 240px; /* Height for larger screens */
  object-fit: cover; /* Ensure images are properly cropped */
  display: block; /* Prevent gaps */
}
...
@media (max-width: 768px) {
  .slide-2 img {
    width: 240px; /* Even smaller for mobile screens */
...
@media (max-width: 576px) {
  .slide-2 img {
    width: 200px; /* For very small screens */
...
<div class="slider-444">
  <div class="slider-track-2">
    ...
    <a class=" btn btn-primary rounded-pill mt-3 mb-5 text-center " href="{{ url('https://www.instagram.com/emiraticoffee.ae/')}}">FOLLOW US</a>
    </div>
    </div>
