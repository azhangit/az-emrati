                ...
                <div class="align-items-stretch d-flex dropdown">
                    ...
                    <style>
                        .new-dropdown-menu{
                         ...
                         .new-dropdown-menu:hover{color:#000;}
                    </style>
                    <div class="dropdown-menu new-dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-md">
                        <a href="{{ route('profile.index') }}" class="dropdown-item new-dropdown-menu">
                            <i class="las la-user-circle"></i>
                            <span>{{ translate('Profile') }}</span>
                        </a>

                        <a href="{{ route('logout') }}" class="dropdown-item new-dropdown-menu">
