<style>
.form-control-changes .form-control-changes{
    color: #181818 !important;
}


.form-control-changes .dropdown-menu{
    color: #181818 !important;
    padding: 0;
}

.form-control-changes .dropdown-menu .dropdown a{
    color: #181818 !important;
}


.form-control-changes .dropdown-item.active{
...
<div class="modal fade azhan" id="new-address-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
@section('script')
   ...
   //    console.log('▶️ Address‐modal script loaded');
window.add_new_address = function(){

  $('#new-address-modal').modal('show');
}

        function edit_address(address) {
          //  console.log('▶️ edit_address() invoked for id:', address);
