                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import','product_bulk_export','view_product_categories', 'view_all_brands','view_product_attributes','view_colors','view_product_reviews'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('Subscription')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('admin.subscription.index')}}" class="aiz-side-nav-link">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="13.714" viewBox="0 0 16 13.714">
    <g>
      <rect x="1" y="2.5" width="14" height="10" rx="2" fill="#575b6a"/>
      <rect x="1" y="5" width="14" height="1.4" fill="#fff" opacity="0.4"/>
      <rect x="4" y="0.7" width="1.2" height="2.6" rx="0.6" fill="#575b6a"/>
      <rect x="10.8" y="0.7" width="1.2" height="2.6" rx="0.6" fill="#575b6a"/>
      <!-- Optional: Dot for event -->
      <circle cx="8" cy="9" r="1.1" fill="#fff" opacity="0.8"/>
    </g>
  </svg>
                            </div>
...
@can('All_Events')
<li class="aiz-side-nav-item">
    <a href="{{route('events.index')}}" class="aiz-side-nav-link {{ request()->routeIs('events.index') ? 'active' : '' }}">
...
@can('Create_Events')
<li class="aiz-side-nav-item">
    <a href="{{route('events.create')}}" class="aiz-side-nav-link {{ request()->routeIs('events.create') ? 'active' : '' }}">
        <span class="aiz-side-nav-text">{{translate('Create Events')}}</span>
    </a>
</li>
@endcan
...
@can('all_locations')
<li class="aiz-side-nav-item">
    <a href="{{route('locations.index')}}" class="aiz-side-nav-link {{ request()->routeIs('locations.index') ? 'active' : '' }}">
        <span class="aiz-side-nav-text">{{translate('All Locations')}}</span>
    </a>
</li>
@endcan
...
<li class="aiz-side-nav-item">
    <a href="{{route('locations.create')}}" class="aiz-side-nav-link {{ request()->routeIs('locations.create') ? 'active' : '' }}">
        <span class="aiz-side-nav-text">{{translate('Create Locations')}}</span>
    </a>
</li>
@endcan
...
<!--    <ul class="aiz-side-nav-list level-2">-->
<!--        <li class="aiz-side-nav-item ">-->
<!--            <a href="{{route('events.index')}}" class="aiz-side-nav-link">-->
<!--                <span class="aiz-side-nav-text">{{translate('All Events')}}</span>-->
<!--            </a>-->
<!--        </li>-->
<!--        <li class="aiz-side-nav-item ">-->
