...
@section('content')
    <div class="card">
        ...
        <div class="col my-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-md-0 h6">{{ translate('All Orders') }}</h5>
                   
    <div class="form-group mb-0">

 <button type="button" class="btn btn-primary" onclick="exportSelectedOrders()">
...
function exportSelectedOrders() {
    const selected = Array.from(document.querySelectorAll('.check-one:checked'));
    if (selected.length === 0) {
        Swal.fire({
            icon: 'warning',
            title: '{{ translate('No orders selected') }}',
    ...
    form.method = 'POST';
    form.action = '{{ route('orders.export.csv') }}';
