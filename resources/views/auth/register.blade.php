...
<div class="h-100 bg-cover bg-center pb-5 " style="background-image: url('https://emrati.acusync.net/public/assets/img/home-page/register-bg.png');"> 
    ...
    <div class="container ">
        <div class="row">
            <div class="col-lg-6 col-xl-4 mx-auto">
                <div class="card text-left rounded-3 p-3 border">
