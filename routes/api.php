...
Route::group(['prefix' => 'v2/auth', 'middleware' => ['app_language']], function () {
    Route::get('new', 'App\Http\Controllers\Api\V2\AuthController@new');
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        //added;
        Route::get('order/details', 'App\Http\Controllers\Api\V2\OrderController@getOrderDetails')->middleware('auth:sanctum');
        //added;
