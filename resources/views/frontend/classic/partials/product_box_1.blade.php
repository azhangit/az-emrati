@php
    $cart_added = [];
@endphp
<div class="aiz-card-box h-auto bg-white pt-4 hov-scale-img" style="background-color: transparent !important;">

<!--<button type="button"  class="btn btn-primary openPopup">Open Popup</button>-->


    <div class="position-relative h-200px h-md-200px w-200px m-auto img-fit overflow-hidden">
        ...
        <!-- Image -->
          ...
          <button class="openPopup d-block h-100 border border-0 m-auto p-0" data-slug="{{ $product->slug }}">
           <img class="lazyload mx-auto img-fit has-transition border border-0"
      ...
      <!--href="{{ $product_url }}"-->
        ...
        <div class="fs-14 mt-auto">
            ...
            @if ($product->auction_product == 0)
                ...
                <!-- price -->
                <div class="">
                    <span class="fw-400 fs-15">{{ home_discounted_base_price($product) }}</span>
                </div>
            @endif
            @if ($product->auction_product == 1)
                <!-- Bid Amount -->
...
#product-box-button .btn-top {
    color: #2997ff !important;
    border-color: #2997ff !important;
}

#product-box-button .btn-top:hover {
    color: #fff !important;
...
@media (max-width: 567px) {
    #product-box-button .btn {
        ...
        <!--b-1-->
        <div class="d-flex justify-content-center gap-2 " id="product-box-button">
        <a class="btn btn-primary w-50 rounded-pill text-white add-to-cart  mt-3 openPopup"  data-slug="{{$product->slug}}"> {{ translate('Buy Now') }} </a>
        <a class="btn  w-50 bg-none btn-top rounded-pill add-to-cart mt-3 openPopup"  data-slug="{{$product->slug}}" >{{ translate('Add to cart') }}</a>
    </div>
    </div>
</div>
