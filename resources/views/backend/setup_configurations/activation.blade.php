...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body text-center">
            <label class="aiz-switch aiz-switch-success mb-0">
                <input type="checkbox" onchange="updateSettings(this, 'guest_checkout')"
                    <?php if (get_setting('guest_checkout') == 1) { echo 'checked'; } ?>>
                <span class="slider round"></span>
            </label>
            <div class="alert"
                style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                {{ translate('Allow customers to checkout without creating an account.') }}
            </div>
        </div>
    </div>
</div>
