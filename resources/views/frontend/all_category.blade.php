...
@section('content')
    ...
    <section class="pt-4 mb-4">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-6 ">
                    <h1 class="fw-700 fs-20 fs-md-24 text-start text-dark">
    ...
    <section class="mb-5 pb-3">
        <div class="container  d-flex">
            @foreach ($categories as $key => $category)
                <div class="mb-4 mx-3 shadow bg-white rounded border ">
                    <!-- Category Name -->
                    <div class="text-dark p-4 align-items-center">
                        <div class="size-200px overflow-hidden  border ">
