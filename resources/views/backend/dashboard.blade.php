...
@section('content')
    ...
    @can('admin_dashboard')
        <div class="row gutters-16">
                ...
                <div class="dashboard-box bg-white mb-2rem overflow-hidden">
                    <div class="row gutters-16">
                        ...
                        <div class="col-sm-6 d-flex flex-column justify-content-between">
                            ...
                            <div>
                                <h2 class="fs-16 fw-600 text-dark mb-2rem d-none">{{ translate('In-house Store') }}</h2>
                        ...
                        <div class="col-sm-6">
                            ...
                            <!-- Ratings -->
                            <div
                                class="bg-soft-secondary rounded-2 h-120px  flex-column justify-content-center text-success px-2rem mb-4 d-none">
                                <h1 class="fs-30 fw-600 text-dark mb-0">
            ...
            <div class="col-lg-6">
                <div class="row gutters-16 d-none">
                    <!-- Top Category -->
                    <div class="col-sm-6">
