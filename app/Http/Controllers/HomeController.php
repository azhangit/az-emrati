...
class HomeController extends Controller
{
    ...
    public function product_json(Request $request, $slug)
    {
        ...
        if ($detailedProduct != null && $detailedProduct->published) {
           ...
           $html = view('frontend.product_details_popup', compact('detailedProduct', 'product_queries', 'total_query', 'reviews', 'review_status'))->render();
                   return response()->json(['html' => $html]); // Return as JSON

        }
        $html = View::make('frontend.product_details_popup', compact('detailedProduct', 'product_queries', 'total_query', 'reviews', 'review_status'))->render(); // Render the Blade view
        return response()->json(['html' => $html]); // Return as JSON
    }
