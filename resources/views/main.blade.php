...
<div class="main-content">
    ...
    <a class="btn btn-primary rounded-pill " href="{{ url('https://emiraticoffee.ae/category/coffee')}}">{{ translate('Shop Now') }}</a>
        <a class="btn bg-none btn-top rounded-pill my-3 py-2 px-5 openPopup" href="#" data-slug="colombia-arabic-coffee">{{ translate('Buy Now') }}</a>
            </div>
            </div>
...
.hero-section h1, .banner-1 h1,  .banner-2 h1{
    font-size: 56px ;
...
.reel-wrapper {
  ...
  padding: 10px 0;
    ...
    /* Add a custom property for animation speed */
  --scroll-speed: 60s;
}
...
.reel-wrapper:hover {
  --scroll-speed: 100s; /* slower on hover */
}
...
<!--</div>-->
  ...
  <div class="reel-track">
    ...
    <a class=" btn btn-primary rounded-pill mt-3 mb-5 text-center " href="{{ url('https://www.instagram.com/emiraticoffee.ae/')}}">{{ translate('FOLLOW US') }}</a>
    </div>
    </div>
...
$(document).ready(function () {
    // First Carousel (Reel-like behavior)
    ...
    // Second Carousel (No autoplay, 3 items shown, no stage padding)
    ...
    dots: false,
    autoplay: true,
    autoplayTimeout: 0,         // ← No pause between slides
    autoplaySpeed: 12000,       // ← Smooth slow slide
    smartSpeed: 12000,
    ...
    responsive: {
        0: { items: 3, stagePadding: 50 },
        600: { items: 3, stagePadding: 100 },
