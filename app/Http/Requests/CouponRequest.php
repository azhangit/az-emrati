...
{
    $isProductOrSubscription = in_array($this->type, ['product_base', 'subscription_base']);
    $productsRule       = $isProductOrSubscription ? 'required' : 'sometimes';
    $dateRule           = $this->type != 'welcome_base' ? 'required' : 'sometimes';
    $minBuyRule         = !$isProductOrSubscription ? 'required' : 'sometimes';
...
{   
    ...
    // Update: handle both product_base and subscription_base here
    if (in_array($this->type, ['product_base', 'subscription_base'])) {
